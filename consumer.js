...
var spacingValues = [1, 2, 3, 4, 5];

for (s of spacingValues) {
  for (type of [{long:'margin', short:'m'}, {long:'padding', short:'p'}]) {
    ...
    zerocss.addSimpleUtil(type.short, 'r\,' + s, type.long + '-right',  s + 'px', true);
  }
}
